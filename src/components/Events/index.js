...
class Events extends Component {
  state = {activeEventId: '', activeEventDetails: ''}

  setActiveEventId = id => {
    this.setState({activeEventId: id})
  }

  getRegestartionStatus = () => {
  ...
  render() {
    const {activeEventId, activeEventDetails} = this.state
      ...
      <div className="main-container">
        ...
        <div className="event-container">
          <ActiveEventRegistrationDetails
            registrationStatus={this.getRegestartionStatus()}
          />
        </div>
      </div>
    )
